export const products = [
    ...
    {
    id: 2,
    nombre: "Cerveza Corona sixpack 330ml",
    imagen: {
    ...
    {
    id: 5,
    nombre: "Licor Amarula Cream 750ml",
    imagen: {
    ...
    {
    id: 6,
    nombre: "Gin Príncipe de los Apóstoles 700ml",
    imagen: {
    ...
    {
    id: 11,
    nombre: "Vino blanco Cosecha Tardia 750ml",
    imagen: {
